                ...
                try:
                    ...
                    if biz_type in ["Kontribusi", "Refund", "Alteration", "Retur", "Revise", "Batal"]:
                        ...
                        log_entry = {
                            ...
                            "Tabarru (IDR)": 0,
                            "Ujrah (IDR)": 0,
                            "Claim (IDR)": (df["marein share idr"].sum() if "claim" in df.columns else 0)*rate_exchange,
                            "Balance": 0 - (df["marein share idr"].sum() if "claim" in df.columns else 0)*rate_exchange,
                            "REMARKS": remarks,
                            "STATUS": "POSTED",
                            #"ENTRY_TYPE": entry_type,
                            "CREATED_AT": now_wib_naive(),
